...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cartCreatedAt: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMenuCategoryMenuCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    menu_section: Schema.Attribute.Relation<'oneToOne', 'api::menu.menu'>;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceAtOrder: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
